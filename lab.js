...
if (lovesCode === true) {
  ...
  console.log("Coding has its challages.")
}
...
if (temperature >= 80 && rain === true) {
  ...
  console.log("You should wear a short-sleeves t-shirt");
} else if (temperature > 60 && temperature <= 80 && rain === false) {
  console.log("You should wear a long-sleeves t-shirt");
} else if (temperature <= 60 && rain === false) {
  console.log("You should wear a jacket or a sweater");
}
...
var changeMyMind = !changeMyMind;

console.log(`it's new value (it should now read ${changeMyMind})`);
